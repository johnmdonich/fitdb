...
class MessageFields(ColumnarBase):
...
class MessageSubfields(ColumnarBase):
...
class MessageSubfieldMaps(ColumnarBase):
...
class MessageNums(ColumnarBase):
...
class FitTypeProperties(ColumnarBase):
